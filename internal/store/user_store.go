...
func (p *password) Set(plaintextPassword string) error {
	// The higher or lower the number (12) the more complex or simple the password hashing algorithm is.
...
// If the user is an empty user  struct, it is considered anonymous.
